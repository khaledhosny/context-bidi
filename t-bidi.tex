...
function bidi.setup(str)
    ...
    for k,v in next, settings do
        ...
        elseif k == "math" and v == "r2l" then
            nodes.tasks.enableaction("math", "bidi.do_process_math")
...
nodes.tasks.appendaction("vboxbuilders", "normalizers", "bidi.process_alignment")

nodes.tasks.appendaction ("math", "after", "bidi.do_process_math")
nodes.tasks.disableaction("math", "bidi.do_process_math")
